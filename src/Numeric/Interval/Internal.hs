...
-- >>> proper (-1.0 ... 1.0)
-- (-1.0 ... 1.0)
proper :: Ord a => Interval a -> Interval a
proper (I a b) = I (min a b) (max a b)
proper Empty   = Empty
...
-- >>> improper (-1.0 ... 1.0)
-- (1.0 ... -1.0)
improper :: Ord a => Interval a -> Interval a
improper (I a b) = I (max a b) (min a b)
improper Empty   = Empty
...
{-# SPECIALIZE (|^|) :: Interval Double -> Int -> Interval Double #-}
